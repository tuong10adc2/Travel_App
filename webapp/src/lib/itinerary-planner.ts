 ...
 *
 * Port nguyên xi từ functions/src/itinerary-planner.ts (Cloud Function cũ, chặn bởi Blaze)
 * sang chạy trong Next.js API route (Vercel) — logic thuần TypeScript, không đổi gì.
 */
