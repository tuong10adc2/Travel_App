      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-brand-900 via-brand-700 to-brand-500 text-white">
        <div className="mx-auto max-w-5xl px-4 py-20 text-center sm:px-6 lg:px-8 lg:py-28">
          ...
          <div className="mt-5 flex flex-wrap items-center justify-center gap-3 text-sm text-white/80">
            <Link href="/chat" className="flex items-center gap-1.5 rounded-full bg-white/10 px-3.5 py-1.5 hover:bg-white/20">
              <MessageCircle className="h-3.5 w-3.5" /> Hỏi trợ lý AI
            </Link>
            <Link href="/tours" className="flex items-center gap-1.5 rounded-full bg-white/10 px-3.5 py-1.5 hover:bg-white/20">
