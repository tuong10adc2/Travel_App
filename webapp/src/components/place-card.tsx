...
export function PlaceCard({ place }: { place: Place }) {
  return (
    <Link
      ...
      className="group flex flex-col overflow-hidden rounded-2xl border border-border bg-white shadow-sm shadow-slate-900/5 transition-shadow hover:shadow-md"
    >
